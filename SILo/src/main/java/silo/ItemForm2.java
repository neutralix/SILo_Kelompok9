 ...
 * @author Mystery-PC
 */
public class ItemForm2 extends javax.swing.JFrame {
...
//        send all field data
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemForm2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
